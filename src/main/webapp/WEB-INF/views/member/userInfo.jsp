	...
	<div class='container'>
		<form class ='border w-50 rounded p-5 mx-auto shadow mb-5 mt-5' 
			...
			<div class='mt-5 text-center'>				
				...
				<a href="<c:url value='memberList.do?viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyword=${pDto.keyword}&cntPerPage=${pDto.cntPerPage}'/>" class='btn btn-info'>리스트</a>
			</div>
		</form>
	</div>
</body>
